...
<ul class="sidebar navbar-nav">
    ...
    <li class="nav-item channel-sidebar-list">
        ...
        <ul>
            ...
            <li>
                <a href="subscriptions.html">
                <img class="img-fluid" alt="" src="{{asset('front/img/s2.png')}}"> Unboxing  <span class="badge badge-warning">2</span>
                </a>
            </li>
            <li>
                <a href="subscriptions.html">
                <img class="img-fluid" alt="" src="{{asset('front/img/s3.png')}}"> Product / Service  
                </a>
            </li>
            <li>
                <a href="subscriptions.html">
                <img class="img-fluid" alt="" src="{{asset('front/img/s4.png')}}">  Gaming 
                </a>
            </li>
        </ul>
    </li>
